...
export default function FrozenGoodsProfilePage() {
          ...
          <div className="flex flex-col items-center text-center">
            <div className="relative">
              <Avatar
                ...
                size="2xl"
                className="border-4 border-[#0077b6]/20"
              />
              <button className="absolute bottom-0 right-0 w-10 h-10 bg-[#0077b6] rounded-full flex items-center justify-center text-white shadow-lg">
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="flex-1">
                ...
                <p className="font-medium text-foreground">Frozen Goods PWA</p>
              </div>
            </div>
          </div>
        </CardBody>
