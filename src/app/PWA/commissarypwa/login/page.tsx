...
import { Eye, EyeOff, User, Lock, AlertCircle, ChefHat } from "lucide-react";
import {
  Card,
  CardBody,
  Button,
...
export default function CommissaryLoginPage() {
        ...
        <Card variant="elevated" className="shadow-lg">
          <CardBody className="p-6">
            <div className="text-center mb-6">
              <div className="w-16 h-16 bg-[#E07A2F] rounded-2xl flex items-center justify-center mx-auto mb-4">
              ...
              <p className="text-sm text-foreground-muted mt-1">
                Log in to manage commissary inventory
              </p>
            </div>
