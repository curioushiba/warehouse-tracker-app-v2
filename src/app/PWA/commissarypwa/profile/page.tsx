...
export default function CommissaryProfilePage() {
          ...
          <div className="flex flex-col items-center text-center">
            <div className="relative">
              <Avatar
                ...
                size="2xl"
                className="border-4 border-[#E07A2F]/20"
              />
              <button className="absolute bottom-0 right-0 w-10 h-10 bg-[#E07A2F] rounded-full flex items-center justify-center text-white shadow-lg">
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-4">
              <div className="w-10 h-10 bg-[#E07A2F]/10 rounded-xl flex items-center justify-center">
                <User className="w-5 h-5 text-[#E07A2F]" />
              </div>
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="flex-1">
                ...
                <p className="font-medium text-foreground">Commissary PWA</p>
              </div>
            </div>
          </div>
        </CardBody>
