...
const navSections: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "FG Transactions", href: "/admin/frozengoods/transactions", icon: ArrowLeftRight },
    ],
  },
  {
    title: "Commissary",
    items: [
      ...
      { label: "CM Transactions", href: "/admin/commissary/transactions", icon: ArrowLeftRight },
    ],
  },
  {
    title: "Operations",
